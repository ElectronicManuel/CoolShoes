...
public class FunctionalityTest extends TestCase {
	...
	public void testAuftragGeliefert() throws Exception {
		...
		bestellTab.get("statusInput", JComboBox.class).setSelectedIndex(5); // �ndere Bestellstatus in der Combobox
	...
	public void testAuftragBestellt() throws Exception {
		...
		bestellTab.get("statusInput", JComboBox.class).setSelectedIndex(6); // �ndere Bestellstatus in der Combobox
	...
	public void testStatusSetzen() throws Exception{
		...
		bestellTab.get("statusInput", JComboBox.class).setSelectedIndex(1); // �ndere Bestellstatus in der Combobox
